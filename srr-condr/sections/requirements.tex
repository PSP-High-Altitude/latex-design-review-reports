...
\begin{center}
    \begin{tabularx}{0.9\textwidth}{|>{\raggedright}p{2cm}|X|}
        ...
        \multicolumn{2}{|>{\raggedright}p{14cm}|}{Above 150 km, the vehicle would no longer be classified as an amateur rocket and has a different set of FAA requirements.} \\ \hline
    \end{tabularx}
\end{center}
